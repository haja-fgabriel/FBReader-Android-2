...
[[ ! -s ${BUILD_FOLDER}/fbreader/app/VERSION ]] && echo "we are not in the root folder; make sure you run this script from scripts folder, like this: ./${0}; Now exiting" && exit 2
...
./scripts/ftp_upload_apk_to_phone.sh
